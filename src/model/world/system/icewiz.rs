...
use crate::model::world::{World, character::{CharacterID, CharacterType}, component::{CharacterBase, CharacterHealth, GetComponentID, ComponentID, CharacterFlip}, WorldError, WorldInfo};
...
pub fn icewiz_system_init() -> Result<WorldInfo, WorldError> {
